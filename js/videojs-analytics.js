/**
 * videojs-analytics - most from
 * @copyright 2017 Adam Oliver <mail@adamoliver.net>
 * @license MIT
 *
 * portions added by EpicWin.Team, @copyright EpicWin.Team 2022
 */
...
window.gtag = window.gtag || function () {
    console.log( "videojs-analytics.js. Google gtag() not found. Nothing captured" ) ;
  return void 0;
};
...
var analytics = function analytics(options) {
  ...
  this.ready(function () {
    ...
    var progress = {
      ...
      {
	  console.log( "videojs-analytics.js.track(["+action+"],["+label+"]) called", player) ;
    ...
    console.log( "videojs-analytics.js calling registerPlugin()" );
...
analytics.VERSION = '1.0.0-epicwin.03';
